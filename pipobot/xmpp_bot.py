#!/usr/bin/python
#-*- coding: utf-8 -*-
"""This file contains the class 'XMPPBot' which is a bot for jabber MUC"""
...
from pipobot.modules import AsyncModule, ListenModule, MultiSyncModule, PresenceModule, SyncModule, IQModule
from pipobot.user import Occupants
