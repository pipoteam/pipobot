...
def parsedate(day):
    """ Parsing a date with formats :
        dd/mm/yy, dd/mm/YYYY, J+n = 'in [n] days' """
    day = day.lower()
    if "+" in day:
        try:
            #Case J+n
...
def parseall(datehour):
    ...
    #We have date and hour
        ...
        final_date = datetime.datetime(parsed_date.tm_year, parsed_date.tm_mon,
                                       parsed_date.tm_mday, parsed_hour.hour,
                                       parsed_hour.minute)
